            ...
            <div class="profile-sidebar">
                ...
                <div class="profile-info">
                    ...
                    <div class="info-item">
                        ...
                        <input value="<?php echo $_SESSION['user']['phone'] ?? '' ?>" type="tel" placeholder="Numéro de téléphone">
                    </div>
                    <div class="info-item">
                ...
                <div class="content-card">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-field">
                            ...
                            <div class="field-value">
                                <input value="<?php echo $user['birth_day'] ?>" type="date" name="dateNaissance">
                            </div>
                        </div>
                        <div class="info-field">
                            <div class="field-label">Lieu de Naissance</div>
                            <div class="field-value">
                                <input value="<?php echo $user['birth_place'] ?>" type="text" name="lieuNaissance" placeholder="Entrez votre lieu de naissance">
                            </div>
                        </div>
                        <div class="info-field">
