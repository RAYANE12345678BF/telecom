    ...
    <style>
        ...
        * {
        ...
        .buttons-container {
            ...
            width: 100%;
            box-sizing: border-box;
            /* Inclure les marges et bordures dans la largeur */
            overflow: hidden;
            /* Empêcher le débordement du conteneur */
            flex-wrap: wrap;
            /* Permet aux boutons de se réorganiser sur plusieurs lignes si nécessaire */
            padding: 0 10px;
            /* Assurer un peu d'espace autour des boutons */
        }
