...
if ($action == 'create' && !can_do_conge($_SESSION['user_id'], 'conge_maternity')) {
                ...
                <form enctype="multipart/form-data" action="<?= url('actions/demand.php') ?>" method="post" id="formConvocation">
                    ...
                    <div class="section">
                        ...
                        <div x-data="{duree : 30}" class="form-group">
                            ...
                            <select :value="<?= $demand['duree'] ?>" x-init="$watch('duree', (e) => $el.value=e)" :name="duree!=-1 ? 'duree' : 'duree2'" @change="duree = $el.value" id="duree-select" class="form-input">
                    ...
                    <script>
                        function handlePrintButton(e) {
                            ...
                            let status = "<?= $action == 'view' ? french($demand['status']) : '' ?>"
