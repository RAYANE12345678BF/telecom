...
$requests = fetch_creation_demands();
...
<head>
    ...
    <script>
        function handleAccount(type, id){
            ...
            fetch("<?= url('actions/accounts.php') ?>", {
                method : "post",
                body : data
            }).then(res => res.json())
            .then(js => {
...
<body>
        ...
        <div class="sidebar-content">
            <div class="menu-items">
                ...
                <div class="request-section">
                    ...
                    <a href="<?= url('profiles/directeur/demands') ?>" class="menu-item">
    ...
    <div class="main-content">
        ...
        <table>
            ...
            <tbody>
                <?php foreach($requests as $demand): $user_info = fetch_user_information($demand['id']) ?>
                <tr>
                    <td>#<?= $demand['id'] ?></td>
                    <td><?= $demand['nom'].' '.$demand['prenom'] ?? 'congé annual' ?></td>
                    <td><?= $demand['email_professionnel'] ?></td>
