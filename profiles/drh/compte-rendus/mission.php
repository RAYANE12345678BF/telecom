    ...
    <div class="sidebar">
        ...
        <div class="sidebar-content">
            <div class="menu-items">
                ...
                <a href="profile_admin2.html" class="menu-item active">
                    ...
                    <div class="submenu" id="demandeSubmenu" style="display: none;">
                        <div>
                            ...
                            <div class="submenu" id="congeSubmenu" style="display: none;">
                                <a href="annuel_admin2.html" class="menu-item">
                                    <i class="fas fa-sun"></i>
                                    <span class="menu-text">Congé Annuel</span>
                                </a>
                                <a href="maladie_admin2.html" class="menu-item">
                                    <i class="fas fa-hospital"></i>
                                    <span class="menu-text">Congé Maladie</span>
                                </a>
                                <a href="maternite_admin2.html" class="menu-item">
                                    <i class="fas fa-baby"></i>
                                    <span class="menu-text">Congé Maternité</span>
                                </a>
                                <a href="rc_admin2.html" class="menu-item">
                                    <i class="fas fa-clock"></i>
                                    <span class="menu-text">Congé RC</span>
                                </a>
                            </div>
                        </div>
                        <a href="formation_admin2.html" class="menu-item">
                            <i class="fas fa-graduation-cap"></i>
                            <span class="menu-text">Demande Formation</span>
                        </a>
                        <a href="mission_admin2.html" class="menu-item">
                            <i class="fas fa-plane"></i>
                            <span class="menu-text">Demande Ordre Mission</span>
                        </a>
                        <a href="Déplacement_admin2.html" class="menu-item">
                            <i class="fas fa-car"></i>
                            <span class="menu-text">Demande Déplacement</span>
                        </a>
                        <a href="sortie_admin2.html" class="menu-item">
                            <i class="fas fa-door-open"></i>
                            <span class="menu-text">Demande Sortie</span>
                        </a>
                    </div>
                    <a href="etat_demande_admin2.html" class="menu-item">
                        <i class="fas fa-tasks"></i>
                        <span class="menu-text">État de demande</span>
                    </a>
                    <a href="consulter_demande_admin2.html" class="menu-item">
                        <i class="fas fa-eye"></i>
                        <span class="menu-text">Consulter Demande</span>
                    </a>
                    <a href="voir_pointage_admin2.html" class="menu-item">
                        <i class="fas fa-clock"></i>
                ...
                <a href="support_admin2.html" class="menu-item">
                    <i class="fas fa-question-circle"></i>
                    <span class="menu-text">Support</span>
                </a>
                <!-- Nouveau bouton "Calendrier RC d'Employé" -->
                <a href="calendrier_admin2.html" class="menu-item">
