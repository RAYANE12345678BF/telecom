...
<body>
    ...
    <div class="content">
        <div class="container">
            <div class="form-card">
                <div class="header">
                    <h1 class="title">Demande de Sortie </h1>
                </div>
                <form id="formConvocation" onsubmit="handleSubmit(event)">
                    ...
                    <div class="section">
                         <h3 class="section-title">Détails de sortie </h3>
                        ...
                        <div class="form-group-row">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="date-entrée">date d'entrée</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="Motif" class="form-input" required>
                        </div>
                    </div>
