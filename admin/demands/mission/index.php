...
<head>
    ...
    min-height: 120vh;  /* Augmenter la hauteur minimale pour étendre la taille du formulaire */
}
...
.form-group-row .form-group {
    ...
    overflow: hidden; /* Empêcher le débordement du conteneur */
    flex-wrap: wrap; /* Permet aux boutons de se réorganiser sur plusieurs lignes si nécessaire */
    padding: 0 10px; /* Assurer un peu d'espace autour des boutons */
}
        ...
        <div class="sidebar-content">
            <div class="menu-items">
                ...
                <div class="request-section">
                    ...
                    <a href='consulter_demande_admin1.html' class='nav-link'>
                        <i class='fas fa-eye'></i> Consulter Demande
                    </a>
                </div>
