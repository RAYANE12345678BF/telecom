        ...
        <div class="container">
            <div class="form-card">
                ...
                <form id="formConvocation" onsubmit="handleSubmit(event)">
                    ...
                    <div class="section">
                       <h3 class="section-title">Détails de déplacement </h3>
                        <div class="form-group-row">
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="Motif_déplacement">Motif de la déplacemnt </label>
                            <input type="text" id="Motif_déplacement" class="form-input" required>
                        </div>
